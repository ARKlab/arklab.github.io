...
const mobileIcons=[25,32,48].flatMap(size=>[1,2,3].map(scale=>`<bt:Image size="${size}" scale="${scale}" resid="${size===48?'Icon80x80':'Icon32x32'}"/>`)).join('');
const mobile=`<MobileFormFactor><FunctionFile resid="RuntimeUrl"/><ExtensionPoint xsi:type="MobileMessageReadCommandSurface"><Group id="ArkMobileReadGroup"><Label resid="GroupLabel"/><Control xsi:type="MobileButton" id="ArkMobilePane"><Label resid="PaneLabel"/><Icon xsi:type="bt:MobileIconList">${mobileIcons}</Icon><Action xsi:type="ShowTaskpane"><SourceLocation resid="TaskpaneUrl"/></Action></Control></Group></ExtensionPoint><ExtensionPoint xsi:type="LaunchEvent"><LaunchEvents><LaunchEvent Type="OnNewMessageCompose" FunctionName="arkOnCompose"/><LaunchEvent Type="OnMessageFromChanged" FunctionName="arkOnFromChanged"/></LaunchEvents><SourceLocation resid="RuntimeUrl"/></ExtensionPoint></MobileFormFactor>`;
...
<SupportsSharedFolders>true</SupportsSharedFolders>${command('MessageReadCommandSurface','ArkReadPane')}${command('MessageComposeCommandSurface','ArkComposePane')}
<ExtensionPoint xsi:type="LaunchEvent"><LaunchEvents><LaunchEvent Type="OnNewMessageCompose" FunctionName="arkOnCompose"/><LaunchEvent Type="OnMessageFromChanged" FunctionName="arkOnFromChanged"/></LaunchEvents><SourceLocation resid="RuntimeUrl"/></ExtensionPoint></DesktopFormFactor>${mobile}</Host></Hosts>
